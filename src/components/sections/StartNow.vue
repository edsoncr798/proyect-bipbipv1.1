    ...
    <article class="py-[30px] max-w-[1065px] mx-auto">
      ...
      <div class="w-full flex justify-between flex-wrap mt-[30px]">
        <div class="mb-[10px]">
          ...
          <p
            class="text-white font-[Baloo-Bhaina-2] not-italic font-normal text-[8px] md:text-[10px] lg:text-[16px] lg:leading-[32px]"
          >
            AV. Freyre 2024, Iquitos - Perú
          </p>
          <p
            class="text-white font-[Baloo-Bhaina-2] not-italic font-normal text-[8px] md:text-[10px] lg:text-[16px] lg:leading-[32px]"
          >
        ...
        <div>
          <h2
            class="text-white not-italic font-semibold text-[10px] md:text-[15px] lg:text-[20px] lg:leading-[40px]"
          >
            INFORMACIÓN
          </h2>
          <p
